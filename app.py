...
def anime():
    ...
    <head>
        ...
        <style>
            body { background-color: #0b0b13; color: white; font-family: 'Segoe UI', sans-serif; }
            .navbar { background-color: #12121f !important; }
            .anime-card { background-color: #16162a; border-radius: 14px; overflow: hidden; transition: 0.3s; height: 100%; }
            .anime-card:hover { transform: translateY(-10px); box-shadow: 0 15px 30px rgba(233,69,96,0.3); }
            .anime-img { height: 320px; width: 100%; object-fit: cover; }
            .anime-info { padding: 16px; }
            .anime-title { font-size: 1.1rem; font-weight: 600; margin-bottom: 4px; }
            .anime-genre { font-size: 0.85rem; color: #aaa; }
        </style>
    </head>
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark">
...
def manga():
    ...
    <head>
        ...
        <style>
            body { background-color: #0b0b13; color: white; font-family: 'Segoe UI', sans-serif; }
            .navbar { background-color: #12121f !important; }
            .manga-card { background-color: #16162a; border-radius: 14px; overflow: hidden; transition: 0.3s; height: 100%; }
            .manga-card:hover { transform: translateY(-10px); box-shadow: 0 15px 30px rgba(233,69,96,0.3); }
            .manga-img { height: 320px; width: 100%; object-fit: cover; }
            .manga-info { padding: 16px; }
            .manga-title { font-size: 1.1rem; font-weight: 600; margin-bottom: 4px; }
            .manga-genre { font-size: 0.85rem; color: #aaa; }
        </style>
    </head>
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark">
